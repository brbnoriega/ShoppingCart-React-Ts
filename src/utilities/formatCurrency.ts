...
const CURRENCY_FORMATTER = new Intl.NumberFormat('es-AR',{ //representa el español utilizado en Arg
...
export function formatCurrency(number: number){ //se define un valor numérico que se formateará utilizando el objeto 
